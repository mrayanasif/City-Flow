...
M. Rayan Asif	Project Lead	Initial Project Setup & Sensor Modules
Uzan Khan	Backend & Frontend	Backend Integration, Dashboard, Supabase API & ESP32 Firmware
Partner 2	Firmware	OTA Updates & WiFi Manager
Partner 3	Firmware	Sensor Fusion & SD Card Logging
